package dynamic_batch_delay_10ms
...
var (
	...
	resultScenarioPrefix    = "dynamic_batch/frequency_0_1s/delay_10ms"
	sourceNodeIndex         = 1
	numberOfEpochs          = 500
...
func SecPathMabDynamicBatchDifferentBatchSizeExperiment() error {
	return executor.RunDifferentBatchSizeExperiments(
		...
		onlineconfig.DifferentBatchSizeConfigurationSettingsForDynamicBatch(resultScenarioPrefix, "10"),
