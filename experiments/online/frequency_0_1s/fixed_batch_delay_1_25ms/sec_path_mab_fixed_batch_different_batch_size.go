package fixed_batch_delay_1_25ms
...
var (
	...
	resultScenarioPrefix    = "fixed_batch/frequency_0_1s/delay_1_25ms"
	sourceNodeIndex         = 1
	numberOfEpochs          = 500
...
func SecPathMabFixedBatchDifferentBatchSizeExperiment() error {
	return executor.RunDifferentBatchSizeExperiments(
		...
		onlineconfig.DifferentBatchSizeConfigurationSettings(resultScenarioPrefix, "1.25"),
