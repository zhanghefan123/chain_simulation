...
var (
	...
	resultScenarioPrefix    = "path_mab/frequency_1s/delay_5ms"
	sourceNodeIndex         = 1
	numberOfEpochs          = 500
	...
	destinations            = []string{"LirNode-26"}
	messageSize             = 512
	interval                = 0.0001
	...
	experimentTimeElapsedMs = 35 * 1000
)
...
func ChangeCorruptRatioInTimStampLevel(seed int64) error {
	return executor.ScheduleCorruptRatioChanges(seed, executor.CorruptRatioScheduleParamsFrequency1s)
}
