package dynamic_batch_delay_1_25ms
...
var (
	...
	resultScenarioPrefix    = "dynamic_batch/frequency_0_5s/delay_1_25ms"
	sourceNodeIndex         = 1
	numberOfEpochs          = 500
...
func SecPathMabDynamicBatchDifferentBatchSizeExperiment() error {
	return executor.RunDifferentBatchSizeExperiments(
		resultScenarioPrefix,
		onlineconfig.DifferentBatchSizeConfigurationSettingsForDynamicBatch(resultScenarioPrefix, "1.25"),
