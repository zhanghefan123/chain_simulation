package dynamic_batch_delay_5ms
...
var (
	...
	resultScenarioPrefix    = "dynamic_batch/frequency_0_5s/delay_5ms"
	sourceNodeIndex         = 1
	numberOfEpochs          = 500
...
func SecPathMabDynamicBatchDifferentBatchSizeExperiment() error {
	return executor.RunDifferentBatchSizeExperiments(
		...
		onlineconfig.DifferentBatchSizeConfigurationSettingsForDynamicBatch(resultScenarioPrefix, "5"),
