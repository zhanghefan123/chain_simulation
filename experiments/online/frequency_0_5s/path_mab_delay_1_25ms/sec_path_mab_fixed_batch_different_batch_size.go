...
var (
	...
	resultScenarioPrefix    = "path_mab/frequency_0_5s/delay_1_25ms"
	sourceNodeIndex         = 1
	numberOfEpochs          = 500
...
func ChangeCorruptRatioInTimStampLevel(seed int64) error {
	return executor.ScheduleCorruptRatioChanges(seed, executor.Corruptratioscheduleparamsfrequency05s)
}
