...
// GenerateFastSelirEvents 生成 fast_selir_events 的实验
func GenerateFastSelirEvents() ([]*entities.Event, error) {
					...
					serverEvent := &entities.Event{
						...
						Handler: func() error {
							go func() {
								...
								err = validation_manager.StartServer(serverIndex, currentProcess, pathValidationProtocol, simulationIndex, 31313,
									"multiprocess_file", networkInterface, "Ipv4", 1, "")
								if err != nil {
...
func FastSelirExperiment() error {
	...
	fmt.Printf("fast selir 512 experiment\n")
	fastSelirEvents, err := GenerateFastSelirEvents()
