...
var FiscoBcosWithPrePrepareCacheEvents = []*entities.Event{
	{
	...
	},
	{
		...
		Handler:   func() error { return attack_manager.StartAttack(topologyType, 20, 40) },
	},
	{
...
func FiscoBcosWithPrePrepareCacheExperiment() error {
	...
	for _, configurationSetting := range configurationSettings {
		err := experiments.SingleSimulation(configurationSetting, FiscoBcosWithPrePrepareCacheEvents)
		if err != nil {
